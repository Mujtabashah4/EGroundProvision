        ...
        <div className='min-h-full sm:flex sm:flex-row mx-0 justify-center'>
          <div className='flex-col flex  self-center p-10 sm:max-w-5xl xl:max-w-2xl  z-10'>
            <div className='self-start  lg:flex flex-col  text-white'>
              <h3 className='mb-4 font-bold hidden text-center sm:block text-5xl'>
                Welcome to E-Ground 
              </h3>
              <h3 className='mb-8 mt-0 font-bold hidden text-center sm:block text-5xl'>Provision System</h3>
              ...
              <img
                ...
                alt=''
              />
              <p className='pr-3 font-medium text-center mt-6 hidden sm:block'>
              "Reimagining Accessibility in Sports: The E-Ground Provision System - Enabling Active Lifestyles for All" 
              </p>
            </div>
          </div>
