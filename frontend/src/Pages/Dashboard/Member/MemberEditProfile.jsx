...
function MemberEditProfile() {
  ...
  useEffect(() => {
    const apiUrl = "http://localhost:5000/api/member/profile";
  ...
  const handleImgUpdate = async (e) => {
    ...
    try {
      const response = await axios.put(
        "http://localhost:5000/api/member/profile/change-image",
        formData,
        {
          headers: {
  ...
  const updateDetails = async (e) => {
    ...
    try {
      const response = await axios.put(
        "http://localhost:5000/api/member/profile/change-details",
        data,
        {
          headers: {
