...
var OTPInput = function(_a) {
  ...
  var _f = import_react.default.useState(0), activeInput = _f[0], setActiveInput = _f[1];
  ...
  return import_react.default.createElement("div", { style: Object.assign({ display: "flex", alignItems: "center" }, isStyleObject(containerStyle) && containerStyle), className: typeof containerStyle === "string" ? containerStyle : void 0 }, Array.from({ length: numInputs }, function(_, index) {
    return index;
  }).map(function(index) {
    var _a2, _b2, _c2;
