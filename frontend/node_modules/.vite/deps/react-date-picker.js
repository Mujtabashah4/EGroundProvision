...
function MonthSelect(_a) {
  ...
  var maxMonth = safeMin(12, maxDate && isSameYear(maxDate) && getMonthHuman(maxDate));
  var minMonth = safeMax(1, minDate && isSameYear(minDate) && getMonthHuman(minDate));
  var dates = __spreadArray2([], Array(12), true).map(function(el, index) {
...
var allValueTypes = __spreadArray3(__spreadArray3([], allViews.slice(1), true), ["day"], false);
...
function renderCustomInputs(placeholder, elementFunctions, allowMultipleInstances) {
  ...
  return placeholder.split(pattern).reduce(function(arr, element, index) {
    ...
    var res = __spreadArray3(__spreadArray3([], arr, true), [divider], false);
...
var isValueType = import_prop_types2.default.oneOf(allValueTypes2);
...
var isRef = import_prop_types2.default.oneOfType([
  import_prop_types2.default.func,
  import_prop_types2.default.exact({
    current: import_prop_types2.default.any
  })
]);
var rangeOf = function(type) {
  return import_prop_types2.default.arrayOf(type);
};
...
var DatePicker = function DatePicker2(props) {
  ...
  return import_react10.default.createElement(
    "div",
    __assign6({ className: clsx_default(baseClassName, "".concat(baseClassName, "--").concat(isOpen ? "open" : "closed"), "".concat(baseClassName, "--").concat(disabled ? "disabled" : "enabled"), className), "data-testid": dataTestid, id }, eventProps, { onFocus: onFocus2, ref: wrapper }),
    renderInputs(),
    renderCalendar()
  );
};
var isValue = import_prop_types3.default.oneOfType([import_prop_types3.default.string, import_prop_types3.default.instanceOf(Date)]);
var isValueOrValueArray = import_prop_types3.default.oneOfType([isValue, rangeOf(isValue)]);
DatePicker.propTypes = {
  autoFocus: import_prop_types3.default.bool,
  calendarAriaLabel: import_prop_types3.default.string,
  calendarClassName: import_prop_types3.default.oneOfType([import_prop_types3.default.string, import_prop_types3.default.arrayOf(import_prop_types3.default.string)]),
  calendarIcon: import_prop_types3.default.oneOfType([import_prop_types3.default.node, import_prop_types3.default.func]),
  ...
  clearAriaLabel: import_prop_types3.default.string,
  clearIcon: import_prop_types3.default.oneOfType([import_prop_types3.default.node, import_prop_types3.default.func]),
  closeCalendar: import_prop_types3.default.bool,
  "data-testid": import_prop_types3.default.string,
  dayAriaLabel: import_prop_types3.default.string,
  dayPlaceholder: import_prop_types3.default.string,
  disableCalendar: import_prop_types3.default.bool,
  ...
  maxDate: isMaxDate,
  maxDetail: import_prop_types3.default.oneOf(allViews3),
  minDate: isMinDate,
  monthAriaLabel: import_prop_types3.default.string,
  monthPlaceholder: import_prop_types3.default.string,
  name: import_prop_types3.default.string,
  nativeInputAriaLabel: import_prop_types3.default.string,
  onCalendarClose: import_prop_types3.default.func,
  onCalendarOpen: import_prop_types3.default.func,
  onChange: import_prop_types3.default.func,
  onFocus: import_prop_types3.default.func,
  openCalendarOnFocus: import_prop_types3.default.bool,
  portalContainer: isBrowser3 ? import_prop_types3.default.instanceOf(HTMLElement) : void 0,
  required: import_prop_types3.default.bool,
  returnValue: import_prop_types3.default.oneOf(["start", "end", "range"]),
  showLeadingZeros: import_prop_types3.default.bool,
  value: isValueOrValueArray,
  yearAriaLabel: import_prop_types3.default.string,
  yearPlaceholder: import_prop_types3.default.string
};
